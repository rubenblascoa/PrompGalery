...
<?php if ($datos['usuario']): ?>
// Perfil para pre-rellenar el modal de edición
window.PV_PERFIL = {
    bio:       <?php echo json_encode($datos['usuario_perfil']->bio ?? ''); ?>,
    ciudad:    <?php echo json_encode($datos['usuario_perfil']->ciudad ?? ''); ?>,
    sitio_web: <?php echo json_encode($datos['usuario_perfil']->sitio_web ?? ''); ?>,
};
<?php endif; ?>
</script>
